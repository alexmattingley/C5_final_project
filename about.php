    ...
    <div class="container-fluid about-text">
        <div class="col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2">
            <div class="intro">
                <h4>Note: If you are looking for information about how this site was built, checkout the <a href="https://github.com/alexmattingley/C5_final_project">github repo</a>.</h4>
